...
void InitializeEffectInfo() {
    ...
    ADD_EFFECT(EFFECT_VAMPIRE,           "Vampire",                  "Heal back 60 percent of all your damage dealt when not overhealed.");
    ...
    ADD_EFFECT(EFFECT_SCHADENFREUDE,     "Schadenfreude",            "After each kill, you have a 33 percent chance to taunt.");
    ADD_EFFECT(EFFECT_RNGDEATH,          "Spontaneous Combustion",   "You have a 1 percent chance of dying each second and a rare 0.01 percent chance of everyone dying.");
    ADD_EFFECT(EFFECT_MATH,              "Perfect Math Class",       "You will sometimes receive a math question. Answer within 8 seconds or die.");
    ADD_EFFECT(EFFECT_WEAKLINGS,         "Weaklings",                "All damage is reduced to 33 percent.");
